 ...
 *
 * @param {vow.Promise} response
 */
ResponseHandler.prototype._parseHttpResponse = function (response) {
    var self = this,
    ...
    this._compressMethod = this.request._options.compress || headers['content-encoding'] || null;
    this._encoding = this.request._options.encoding || this._getEncodingFromHeaders(headers) || 'utf8';
