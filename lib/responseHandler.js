...
ResponseHandler.prototype._parseHttpResponse = function (response) {
    ...
    this._compressMethod = this.request.compress || headers['content-encoding'] || null;
    this._encoding = this.request.encoding || this._getEncodingFromHeaders(headers) || 'utf8';
